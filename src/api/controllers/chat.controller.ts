...
export class ChatController {
  ...
  public async whatsappNumber(
    ...
    logger.verbose(
      'requested whatsappNumber from ' + instanceName + ' instance',
    )
  ...
  public async markChatUnread(
    ...
    logger.verbose(
      'requested markChatUnread from ' + instanceName + ' instance',
    )
  ...
  public async fetchProfilePicture(
    ...
    logger.verbose(
      'requested fetchProfilePicture from ' + instanceName + ' instance',
    )
  ...
  public async fetchStatusMessage(
    {instanceName}: InstanceDto,
    query: MessageUpQuery,
  ) {
    logger.verbose(
      'requested fetchStatusMessage from ' + instanceName + ' instance',
    )
  ...
  public async fetchPrivacySettings({instanceName}: InstanceDto) {
    logger.verbose(
      'requested fetchPrivacySettings from ' + instanceName + ' instance',
    )
  ...
  public async updatePrivacySettings(
    ...
    logger.verbose(
      'requested updatePrivacySettings from ' + instanceName + ' instance',
    )
  ...
  public async fetchBusinessProfile(
    ...
    logger.verbose(
      'requested fetchBusinessProfile from ' + instanceName + ' instance',
    )
  ...
  public async updateProfileName(
    ...
    logger.verbose(
      'requested updateProfileName from ' + instanceName + ' instance',
    )
  ...
  public async updateProfileStatus(
    ...
    logger.verbose(
      'requested updateProfileStatus from ' + instanceName + ' instance',
    )
  ...
  public async updateProfilePicture(
    ...
    logger.verbose(
      'requested updateProfilePicture from ' + instanceName + ' instance',
    )
  ...
  public async removeProfilePicture({instanceName}: InstanceDto) {
    logger.verbose(
      'requested removeProfilePicture from ' + instanceName + ' instance',
    )
