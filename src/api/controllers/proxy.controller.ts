...
export class ProxyController {
  ...
  public async createProxy(instance: InstanceDto, data: ProxyDto) {
    logger.verbose(
      'requested createProxy from ' + instance.instanceName + ' instance',
    )
  ...
  public async findProxy(instance: InstanceDto) {
    logger.verbose(
      'requested findProxy from ' + instance.instanceName + ' instance',
    )
  ...
  public async testProxy(proxy: ProxyDto['proxy']) {
    ...
    try {
      ...
      logger.verbose(
        '[testProxy] from IP: ' + response?.data + ' To IP: ' + serverIp?.data,
      )
