...
export class ChatwootController {
  ...
  public async findChatwoot(instance: InstanceDto) {
    logger.verbose(
      'requested findChatwoot from ' + instance.instanceName + ' instance',
    )
  ...
  public async receiveWebhook(instance: InstanceDto, data: any) {
    ...
    const chatwootCache = new CacheService(
      new CacheEngine(this.configService, ChatwootService.name).getEngine(),
    )
