...
export class TypebotController {
  ...
  public async createTypebot(instance: InstanceDto, data: TypebotDto) {
    logger.verbose(
      'requested createTypebot from ' + instance.instanceName + ' instance',
    )
  ...
  public async findTypebot(instance: InstanceDto) {
    logger.verbose(
      'requested findTypebot from ' + instance.instanceName + ' instance',
    )
  ...
  public async changeStatus(instance: InstanceDto, data: any) {
    logger.verbose(
      'requested changeStatus from ' + instance.instanceName + ' instance',
    )
  ...
  public async startTypebot(instance: InstanceDto, data: any) {
    logger.verbose(
      'requested startTypebot from ' + instance.instanceName + ' instance',
    )
