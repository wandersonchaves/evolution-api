  ...
  public async create(
    ...
    try {
      ...
      if (this.dbSettings.ENABLED) {
        ...
        const insert = await this.integrationModel.replaceOne(
          {_id: instance},
          {...data},
          {upsert: true},
        )
        ...
        this.logger.verbose(
          'integration saved to db: ' + insert.modifiedCount + ' integration',
        )
      ...
      this.logger.verbose(
        'integration saved to store in path: ' +
          join(this.storePath, 'integration') +
          '/' +
          instance,
      )
