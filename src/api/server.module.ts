...
import {WAMonitoringService} from '@root/application/chat/use-cases/monitor.service'
import {ProxyService} from '@root/application/chat/use-cases/proxy.service'
import {SettingsService} from '@root/application/chat/use-cases/settings.service'
import {TemplateService} from '@root/application/chat/use-cases/template.service'
import {PrismaRepository} from '@root/infrastructure/database/repositories/repository/repository.service'
import {CallController} from '@root/interfaces/http/controllers/call.controller'
import {ChatController} from '@root/interfaces/http/controllers/chat.controller'
import {GroupController} from '@root/interfaces/http/controllers/group.controller'
import {InstanceController} from '@root/interfaces/http/controllers/instance.controller'
import {LabelController} from '@root/interfaces/http/controllers/label.controller'
import {ProxyController} from '@root/interfaces/http/controllers/proxy.controller'
import {SendMessageController} from '@root/interfaces/http/controllers/sendMessage.controller'
import {SettingsController} from '@root/interfaces/http/controllers/settings.controller'
import {TemplateController} from '@root/interfaces/http/controllers/template.controller'
